...
#Class Structured kde
class Structured_kde():
    
    '''
    args :    - structure : list of list, partition of {0, 1, ..., d-1} corresponding to independence structure
              - h : bandwith vector (size must correspond to independance structure)
           
    methods : - fit : compute histogram and empirical log-likelihood
              - test_log_likelihood : compute log_likelihood on another set (must be call after fit)
    ...
    def __init__(self, structure, bandwidths):
